...
void texture_assets::initialize() {
	...
	load({ &objects.player.jump[0], "jump.png", 11, TEXTURE_IS_ANIMATED });
	load({ &objects.player.jump[1], "run.png", 11, TEXTURE_IS_ANIMATED });
	...
	load({ &objects.chaser.jump[0], "jump.png", 7, TEXTURE_IS_ANIMATED });
